...
//	zipInfo.dosDate = (unsigned long) current;
	NSError *er;//Fixed by Ladan
	NSDictionary* attr = [[NSFileManager defaultManager] attributesOfItemAtPath:file error:&er]; //fileAttributesAtPath:file traverseLink:YES];
	if( attr )
	{
