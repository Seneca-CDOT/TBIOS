...
//-(IBAction) viewFirstNationList: (id) sender{
//    [self.navigationController presentModalViewController:self.searchList animated:YES];
// 
// }
...
//    if (searchList == nil)
//    {
//        searchList = [[SearchListController alloc] initWithNibName:@"SearchListView" bundle:nil];
...
//{
//    if (searchListNavigationController == nil)
//    {
//        searchListNavigationController = [[UINavigationController alloc] initWithRootViewController:self.searchList];
//    }
//    return searchListNavigationController;
//}

//- (void)SearchListController: (SearchListController*) controller didSelectFirstNation:(FirstNation *) nation{
//
//    [self.navigationController dismissModalViewControllerAnimated:YES];
//    self.title = nation.name;
...
//    NSArray * districts;
//    // GPS point
//    if (self.remoteHostStatus == NotReachable ) {   //works locally 
//    
//    ReverseGeocoder * rgc = [[ReverseGeocoder alloc] init];
//    rgc.managedObjectContext = self.managedObjectContext;
//      
//    districts=[rgc findDistrictForCoordinateWithLat:[nation.latitude doubleValue] AndLng:[nation.longitude   doubleValue]];
//
//    [self drawOverlaysOfArray:districts];
//   
//   //     DistrictCenterAnnotation * anotation = [[[DistrictCenterAnnotation alloc] initWithLatitude:[nation.latitude doubleValue] andLongitude:[nation.longitude doubleValue]]autorelease];
//   // anotation.title = nation.name;
//  //  anotation.subTitle= @"";
//  //  [mapView addAnnotation:anotation];
//
//    }else{// works online
//
//        CLLocation *location = [[CLLocation alloc] initWithLatitude:[nation.latitude doubleValue] longitude:[nation.longitude doubleValue]];
//        LocationDetector * ld = [[LocationDetector alloc]initWithRetrieveOption:Network WithManagedObjectContext:self.managedObjectContext];
//        ld.delegate = self;
//        [ld getDistrictsFromWebServiceForLocation:location];
//    }
//   
//   }
//
