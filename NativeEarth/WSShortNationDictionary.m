...
#import "WSShortNationDictionary.h"
#import "WSShortNation.h"

@implementation WSShortNationDictionary
#pragma Mark -
...
-(id)initWithManagedObjectContext:(NSManagedObjectContext *) context{
    ...
    for (NSDictionary * land  in results) {
        WSLandShort * landShort = [[WSLandShort alloc] initWithDictionary:land];        
